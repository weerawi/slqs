...
//         >
//           <a href="tel:+96550480958" style={{ backdropFilter: 'blur(3px)', background: 'rgba(0, 0, 0, 0.6)' }} className='rounded-2xl group p-3 gap-2 w-96 flex items-center'>
//             <MdCall className='text-xl group-hover:animate-ping' /> +965 504 80958
//           </a>

//           <a href="mailto:secretary@slqs-eng-kuwait.org" style={{ backdropFilter: 'blur(3px)', background: 'rgba(0, 0, 0, 0.6)' }} className='rounded-2xl group p-3 gap-2 w-96 flex items-center'>
//             <MdEmail className='text-xl group-hover:animate-pulse' /> secretary@slqs-eng-kuwait.org
//           </a>

//           <div style={{ backdropFilter: 'blur(3px)', background: 'rgba(0, 0, 0, 0.6)' }} className='rounded-2xl group p-3 gap-2 w-96 flex flex-col justify-center'>
...
//               <div 
//               data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="1400"
//               className="absolute inset-0 transform -skew-y-3 rotate-5 rounded-3xl flex items-center justify-center p-4 sm:p-14 md:p-16">
