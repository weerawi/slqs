...
const GalListProduct = () => {
  ...
  return (
    <div className="flex flex-col items-center   mx-auto"> 
        ...
        <div className=" font-semibold  items-center grid grid-cols-4 gap-1 md:gap-2 lg:gap-10 py-1 justify-around  w-[1000px]">
        ...
        <div className="my-5 py-5  bg-gray-50 overflow-y-scroll h-2/3">
            ...
            {galAllProducts.map((product,i) => {
                ...
                return  <div key={i} className=" w-[1000px]   items-center border-b-2  grid grid-cols-4 gap-1 md:gap-2 lg:gap-10 py-1 
                border-gray-400 ">
